...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($description) || empty($price)) {
        ...
        if (empty($error)) {
            try {
                $stmt = $conn->prepare("UPDATE products SET name = ?, description = ?, price = ?, image_url = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?");
        ...
        <div class="admin-main">
            ...
            <div class="form-container">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="submit-btn">更新产品</button>
                </form>
